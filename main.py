...
#This is a simple game where the user uses the keyboard to move the pirate around a board and pick up booty
#there are also some obstacles such as cannibals in the pirates way
#this was a project that lasted from february to april 2021
